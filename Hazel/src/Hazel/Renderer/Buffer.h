...
namespace Hazel
{
    ...
    static unsigned int ShaderDataTypeSize(ShaderDataType type)
    {
        switch (type)
        {
        case ShaderDataType::Float: case ShaderDataType::Int: return 4;
        case ShaderDataType::Float2: case ShaderDataType::Int2: return 4 * 2;
        case ShaderDataType::Float3: case ShaderDataType::Int3: return 4 * 3;
        case ShaderDataType::Float4: case ShaderDataType::Int4: return 4 * 4;
    ...
    struct BufferElement
    {
        ...
        unsigned int GetComponentCount() const
        {
            switch (Type)
            {
            case ShaderDataType::Float: case ShaderDataType::Int: return 1;
    ...
    public:
        ...
        virtual void SetData(const void* data, long long size) const = 0;

        static Ref<VertexBuffer> Create(unsigned size);
        static Ref<VertexBuffer> Create(float* vertices, unsigned size);
    };
